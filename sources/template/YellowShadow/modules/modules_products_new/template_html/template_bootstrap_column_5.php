    ...
    <article class="itemlist">
      <div class="row row-sm">
        <aside class="col-sm-3">
          <div class="img-wrap ModulesProductsNewBoostrapColumn5Image"><?php echo $products_image . $ticker; ?></div>
        </aside> <!-- col.// -->
        <div class="col-sm-6">
          <div class="text-wrap">
            <h4 class="title ModulesProductsNewBoostrapColumn5Title"><?php echo $products_name; ?></h4>
<?php
...
?>
                <p><span class="ModulesProductsNewBoostrapColumn5StockImage"><?php echo $products_stock; ?></span></p>
<?php
  }
  if (!empty($min_order_quantity_products_display)) {
?>
                <p><span class="ModulesProductsNewBoostrapColumn5QuantityMinOrder"><?php echo  $min_order_quantity_products_display; ?></span></p>
<?php
  }
