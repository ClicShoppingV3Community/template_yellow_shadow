  ...
  class ml_login_mode_guest_account {
    ...
    public function install() {
      ...
      $CLICSHOPPING_Db->save('configuration', [
          ...
          'configuration_key' => 'MODULE_LOGIN_MODE_GUEST_ACCOUNT_STATUS',
      ...
      $CLICSHOPPING_Db->save('configuration', [
          ...
          'configuration_key' => 'MODULE_LOGIN_MODE_GUEST_ACCOUNT_CONTENT_WIDTH',
      ...
      $CLICSHOPPING_Db->save('configuration', [
          ...
          'configuration_key' => 'MODULE_LOGIN_MODE_GUEST_ACCOUNT_POSITION',
          'configuration_value' => 'float-none',
          'configuration_description' => 'Select where you want display the module',
          'configuration_group_id' => '6',
          'sort_order' => '2',
          'set_function' => 'clic_cfg_set_boolean_value(array(\'float-right\', \'float-left\', \'float-md-none\'))',
          'date_added' => 'now()'
        ]
      );
      ...
      $CLICSHOPPING_Db->save('configuration', [
          ...
          'configuration_key' => 'MODULE_LOGIN_MODE_GUEST_ACCOUNT_SORT_ORDER',
    ...
    public function keys() {
      return array(
        ...
        'MODULE_LOGIN_MODE_GUEST_ACCOUNT_SORT_ORDER'
      );
    }
  }
