...
?>
        <div class="row">
          <div class="col-md-12">
            <div class="form-group row">
              <label for="inputEmail" class="col-6 col-form-label"><?php echo CLICSHOPPING::getDef('module_login_connexion_entry_email_address'); ?></label>
              <div class="col-md-6">
        ...
        <div class="row">
          <div class="col-md-12">
            <div class="form-group row">
              <label for="inputPassword" class="col-6 col-form-label"><?php echo CLICSHOPPING::getDef('module_login_connexion_entry_password'); ?></label>
              <div class="col-md-6">
