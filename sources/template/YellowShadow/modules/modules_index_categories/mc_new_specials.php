 ...
 */
  ...
  class mc_new_specials {
    ...
    public function __construct() {
      ...
      $this->title = CLICSHOPPING::getDef('module_index_categories_specials_products_title');
      $this->description = CLICSHOPPING::getDef('module_index_categories_specials_products_description');

      if (defined('MODULE_INDEX_CATEGORIES_SPECIALS_PRODUCTS_STATUS')) {
        $this->sort_order = MODULE_INDEX_CATEGORIES_SPECIALS_PRODUCTS_SORT_ORDER;
        $this->enabled = (MODULE_INDEX_CATEGORIES_SPECIALS_PRODUCTS_STATUS == 'True');
      }
    }
...
// needed for the new products module shown below
      ...
      if (CLICSHOPPING::getBaseNameIndex() && $CLICSHOPPING_Category->getPath()) {
        ...
        if (MODULE_INDEX_CATEGORIES_SPECIALS_PRODUCTS_MAX_DISPLAY != 0) {
...
//Depth = products
              ...
              $Qproduct->bindint(':products_limit', (int)MODULE_INDEX_CATEGORIES_SPECIALS_PRODUCTS_MAX_DISPLAY);
...
// delete words
            $delete_word = (int)MODULE_INDEX_CATEGORIES_SPECIALS_SHORT_DESCRIPTION_DELETE_WORLDS;
// display number of short description
            $products_short_description_number = (int)MODULE_INDEX_CATEGORIES_SPECIALS_PRODUCTS_SHORT_DESCRIPTION;
// nbr of column to display  boostrap
            $bootstrap_column = (int)MODULE_INDEX_CATEGORIES_SPECIALS_PRODUCTS_COLUMNS;
// initialisation des boutons
            $size_button = $CLICSHOPPING_ProductsCommon->getSizeButton('md');

// Template define
            $filename = $CLICSHOPPING_Template-> getTemplateModulesFilename($this->group .'/template_html/' . MODULE_INDEX_CATEGORIES_SPECIALS_PRODUCTS_TEMPLATE);

            $new_prods_content = '<!-- Specials Start -->' . "\n";
            $new_prods_content .= '<div class="clearfix"></div>';

            if (MODULE_INDEX_CATEGORIES_SPECIALS_PRODUCTS_FRONT_TITLE != 'false') {
              $new_prods_content .= '<div class="page-title ModuleIndexCategoriesSpecialsHeading"><h2>' . CLICSHOPPING::getDef('module_index_categories_specials_products_heading_title') . '<h2></div>';
            }

            $new_prods_content .= '<div class="d-flex flex-wrap ModuleIndexCategoriesContainerSpecials">';
...
//Stock (good, alert, out of stock).
              $products_stock = $CLICSHOPPING_ProductsFunctionTemplate->getStock(MODULE_INDEX_CATEGORIES_SPECIALS_PRODUCTS_DISPLAY_STOCK, $products_id);
//Flash discount
...
// Display an input allowing for the customer to insert a quantity
              $input_quantity = $CLICSHOPPING_ProductsFunctionTemplate->getDisplayInputQuantity(MODULE_INDEX_CATEGORIES_SPECIALS_PRODUCTS_DELETE_BUY_BUTTON, $products_id);
...
// **************************
              ...
              if (MODULE_INDEX_CATEGORIES_SPECIALS_PRODUCTS_DELETE_BUY_BUTTON == 'False') {
...
// See the button more view details
               $button_small_view_details = $CLICSHOPPING_ProductsFunctionTemplate->getButtonViewDetails(MODULE_INDEX_CATEGORIES_SPECIALS_PRODUCTS_DELETE_BUY_BUTTON, $products_id);
// Display the image
              $products_image = $CLICSHOPPING_ProductsFunctionTemplate->getImage(MODULE_INDEX_CATEGORIES_SPECIALS_PRODUCTS_IMAGE_MEDIUM, $products_id);

// Ticker Image
              $products_image .= $CLICSHOPPING_ProductsFunctionTemplate->getTicker(MODULE_INDEX_CATEGORIES_SPECIALS_PRODUCTS_TICKER, $products_id, 'ModulesIndexCategoriesNewProductsProductsBootstrapTickerSpecial', 'ModulesIndexCategoriesNewProductsBootstrapTickerFavorite', 'ModulesIndexCategoriesNewProductsBootstrapTickerFeatured', 'ModulesIndexCategoriesNewProductsBootstrapTickerNew');

              $ticker = $CLICSHOPPING_ProductsFunctionTemplate->getTickerPourcentage(MODULE_INDEX_CATEGORIES_SPECIALS_PRODUCTS_POURCENTAGE_TICKER, $products_id, 'ModulesIndexCategoriesBootstrapTickerPourcentage');
...
// **************************
    ...
    public function check() {
      return defined('MODULE_INDEX_CATEGORIES_SPECIALS_PRODUCTS_STATUS');
    }
    ...
    public function install() {
      ...
      $CLICSHOPPING_Db->save('configuration', [
          ...
          'configuration_key' => 'MODULE_INDEX_CATEGORIES_SPECIALS_PRODUCTS_STATUS',
      ...
      $CLICSHOPPING_Db->save('configuration', [
          ...
          'configuration_key' => 'MODULE_INDEX_CATEGORIES_SPECIALS_PRODUCTS_TEMPLATE',
      ...
      $CLICSHOPPING_Db->save('configuration', [
          ...
          'configuration_key' => 'MODULE_INDEX_CATEGORIES_SPECIALS_PRODUCTS_FRONT_TITLE',
          'configuration_value' => 'True',
      ...
      $CLICSHOPPING_Db->save('configuration', [
          ...
          'configuration_key' => 'MODULE_INDEX_CATEGORIES_SPECIALS_PRODUCTS_MAX_DISPLAY',
      ...
      $CLICSHOPPING_Db->save('configuration', [
          ...
          'configuration_key' => 'MODULE_INDEX_CATEGORIES_SPECIALS_PRODUCTS_COLUMNS',
          'configuration_value' => '6',
      ...
      $CLICSHOPPING_Db->save('configuration', [
          ...
          'configuration_key' => 'MODULE_INDEX_CATEGORIES_SPECIALS_PRODUCTS_SHORT_DESCRIPTION',
      ...
      $CLICSHOPPING_Db->save('configuration', [
          ...
          'configuration_key' => 'MODULE_INDEX_CATEGORIES_SPECIALS_SHORT_DESCRIPTION_DELETE_WORLDS',
          'configuration_value' => '0',
      ...
      $CLICSHOPPING_Db->save('configuration', [
          ...
          'configuration_key' => 'MODULE_INDEX_CATEGORIES_SPECIALS_PRODUCTS_TICKER',
      ...
      $CLICSHOPPING_Db->save('configuration', [
          ...
          'configuration_key' => 'MODULE_INDEX_CATEGORIES_SPECIALS_PRODUCTS_POURCENTAGE_TICKER',
          'configuration_value' => 'False',
      ...
      $CLICSHOPPING_Db->save('configuration', [
          ...
          'configuration_key' => 'MODULE_INDEX_CATEGORIES_SPECIALS_PRODUCTS_DISPLAY_STOCK',
      ...
      $CLICSHOPPING_Db->save('configuration', [
          ...
          'configuration_key' => 'MODULE_INDEX_CATEGORIES_SPECIALS_PRODUCTS_IMAGE_MEDIUM',
      ...
      $CLICSHOPPING_Db->save('configuration', [
          ...
          'configuration_key' => 'MODULE_INDEX_CATEGORIES_SPECIALS_PRODUCTS_DELETE_BUY_BUTTON',
          'configuration_value' => 'False',
      ...
      $CLICSHOPPING_Db->save('configuration', [
          ...
          'configuration_key' => 'MODULE_INDEX_CATEGORIES_SPECIALS_PRODUCTS_SORT_ORDER',
    ...
    public function keys() {
      return array ('MODULE_INDEX_CATEGORIES_SPECIALS_PRODUCTS_STATUS',
                    'MODULE_INDEX_CATEGORIES_SPECIALS_PRODUCTS_TEMPLATE',
                    'MODULE_INDEX_CATEGORIES_SPECIALS_PRODUCTS_FRONT_TITLE',
                    'MODULE_INDEX_CATEGORIES_SPECIALS_PRODUCTS_MAX_DISPLAY',
                    'MODULE_INDEX_CATEGORIES_SPECIALS_PRODUCTS_COLUMNS',
                    'MODULE_INDEX_CATEGORIES_SPECIALS_PRODUCTS_SHORT_DESCRIPTION',
                    'MODULE_INDEX_CATEGORIES_SPECIALS_SHORT_DESCRIPTION_DELETE_WORLDS',
                    'MODULE_INDEX_CATEGORIES_SPECIALS_PRODUCTS_TICKER',
                    'MODULE_INDEX_CATEGORIES_SPECIALS_PRODUCTS_POURCENTAGE_TICKER',
                    'MODULE_INDEX_CATEGORIES_SPECIALS_PRODUCTS_DISPLAY_STOCK',
                    'MODULE_INDEX_CATEGORIES_SPECIALS_PRODUCTS_IMAGE_MEDIUM',
                    'MODULE_INDEX_CATEGORIES_SPECIALS_PRODUCTS_DELETE_BUY_BUTTON',
                    'MODULE_INDEX_CATEGORIES_SPECIALS_PRODUCTS_SORT_ORDER'
                  );
    }
  }
