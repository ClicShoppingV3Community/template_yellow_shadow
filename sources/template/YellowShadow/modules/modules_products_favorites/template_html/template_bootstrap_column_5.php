    ...
    <article class="itemlist">
      <div class="row row-sm">
        <aside class="col-sm-3">
          <div class="img-wrap ModulesProductsFavoritesBoostrapColumn5Image"><?php echo $products_image . $ticker; ?></div>
        </aside> <!-- col.// -->
        <div class="col-sm-6">
          <div class="text-wrap">
            <h4 class="title ModulesProductsFavoritesBoostrapColumn5Title"><?php echo $products_name; ?></h4>
<?php
...
?>
                <p><span class="ModulesProductsFavoritesBoostrapColumn5StockImage"><?php echo $products_stock; ?></span></p>
<?php
  }
  if (!empty($min_order_quantity_products_display)) {
?>
                <p><span class="ModulesProductsFavoritesBoostrapColumn5QuantityMinOrder"><?php echo  $min_order_quantity_products_display; ?></span></p>
<?php
  }
        ...
        <aside class="col-sm-3">
          <div class="border-left pl-3">
            <div class="price-wrap">
              <span class="h3 ModulesProductsFavoritesBoostrapColumn5TextPrice" ><?php echo CLICSHOPPING::getDef('text_price') . ' ' . $product_price; ?>
