...
?>
          <a data-toggle="modal" data-target="#loginModal"><i class="text-warning fas fa-user fa-1x">&nbsp;&nbsp;</i><?php echo CLICSHOPPING::getDef('modules_header_multi_template_account_login'); ?></a>
...
?>
          ...
          <li class="dropdown"><a href="#" class="dropdown-toggle AlibabaTextHeader" data-toggle="dropdown"><i class="text-warning fas fa-user fa-1x" aria-hidden="true"></i>&nbsp;&nbsp;<?php echo CLICSHOPPING::getDef('modules_header_multi_template_my_account'); ?></a>
...
?>
        ...
        <span class="alibabaTextHeader"><i class="text-warning fas fa-id-card fa-1x" aria-hidden="true"></i>&nbsp;&nbsp;<?php echo HTML::link(ClicShopping::link(null, 'Info&Contact'), CLICSHOPPING::getDef('modules_header_multi_template_title_contact_us')); ?></span>&nbsp;&nbsp;|&nbsp;&nbsp;
        <span class="alibabaTextHeader"><i class="text-warning fas fa-search fa-1x" aria-hidden="true"></i>&nbsp;&nbsp;<?php echo HTML::link(ClicShopping::link(null, 'Search&AdvancedSearch'), CLICSHOPPING::getDef('modules_header_multi_template_title_advanced_search')); ?></span>
      </div>
    </span>

      <span class="col-lg-4 col-sm-12 text-md-center">
        <a class="navbar-brand" href="#"><?php echo $logo_header; ?></a>
      </span>


    <span class="col-lg-4 col-sm-12 text-md-right">
...
?>
          <ul>
            <li class="dropdown headerMultiTemplateDefaultShoppingCart">
              <a class="dropdown-toggle headerMultiTemplateDefaultShoppingCart" data-toggle="dropdown" href="#"><?php echo '<i class="text-warning fas fa-shopping-cart fa-1x headerMultiTemplateDefaultShoppingCart" aria-hidden="true"></i>&nbsp;&nbsp;&nbsp;&nbsp;' . $shopping_cart ?></a>
              <ul class="dropdown-menu">
...
?>
                ...
                <li role="separator" class="h-divider"></li>
                <li class="headerMultiTemplateDefaultLi">
                  <span class="float-md-left headerMultiTemplateDefaultShoppingSmallCart"><i class="text-warning fas fa-shopping-cart fa-1x">&nbsp;&nbsp;</i><?php echo HTML::link(ClicShopping::link(null, 'Cart'), CLICSHOPPING::getDef('modules_header_multi_template_shopping_cart_view_cart')); ?></span>
...
<?php
          ...
          echo '<ul>
        <li class="headerMultiTemplateDefaultShoppingCart"><i class="text-warning fas fa-shopping-cart fa-1x headerMultiTemplateDefaultShoppingCart" aria-hidden="true"></i>&nbsp;&nbsp;&nbsp;&nbsp;' . CLICSHOPPING::getDef('modules_header_multi_template_shopping_cart_no_content') . '</li>
        </ul>
        ';
   }
?>
...
<section class="header-main">
    <div class="">
      <div class="row-sm align-items-center">
        ...
        <div class="col-lg-15-24 col-sm-8">
