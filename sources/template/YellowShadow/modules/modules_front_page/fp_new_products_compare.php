 ...
 */
  ...
  class fp_new_products_compare {
    ...
    public function __construct() {
      ...
      $this->title = CLICSHOPPING::getDef('module_front_page_new_products_compare_title');
      $this->description = CLICSHOPPING::getDef('module_front_page_new_products_compare_description');

      if (defined('MODULE_FRONT_PAGE_NEW_PRODUCTS_COMPARE_STATUS')) {
        $this->sort_order = (int)MODULE_FRONT_PAGE_NEW_PRODUCTS_COMPARE_SORT_ORDER;
        $this->enabled = (MODULE_FRONT_PAGE_NEW_PRODUCTS_COMPARE_STATUS == 'True');
      }
    }
    ...
    public function execute() {
      ...
      $new_products_compare_category_id =  $CLICSHOPPING_Category->getID();

      if (CLICSHOPPING::getBaseNameIndex() && !$CLICSHOPPING_Category->getPath()) {
        if (MODULE_FRONT_PAGE_NEW_PRODUCTS_COMPARE_MAX_DISPLAY != 0) {
          if ($CLICSHOPPING_Customer->getCustomersGroupID() != 0) {
            if ( (!isset($new_products_compare_category_id)) || ($new_products_compare_category_id == 0) ) {
// Display products no inside categories
              ...
              $Qproduct->bindInt(':products_limit', (int)MODULE_FRONT_PAGE_NEW_PRODUCTS_COMPARE_MAX_DISPLAY);
              $Qproduct->execute();
            } else {
// Requetes SQL pour afficher les nouveaux produits groupe B2B lorsque l'on se trouve dans une categorie
              $Qproduct = $CLICSHOPPING_Db->prepare('select p.products_id,
                                                      ...
                                                      limit :products_limit
                                                      ');
              $Qproduct->bindInt(':parent_id', (int)$new_products_compare_category_id);
              $Qproduct->bindInt(':customers_group_id', $CLICSHOPPING_Customer->getCustomersGroupID());
              $Qproduct->bindInt(':products_limit', MODULE_FRONT_PAGE_NEW_PRODUCTS_COMPARE_MAX_DISPLAY);
              $Qproduct->execute();
            }
          } else {
            if (!isset($new_products_compare_category_id) || ($new_products_compare_category_id == 0)) {
...
// display number of short description
            $products_short_description_number = (int)MODULE_FRONT_PAGE_NEW_PRODUCTS_COMPARE_SHORT_DESCRIPTION;
// delete words
            $delete_word = (int)MODULE_FRONT_PAGE_NEW_PRODUCTS_COMPARE_SHORT_DESCRIPTION_DELETE_WORLDS;
// nbr of column to display  boostrap
            $bootstrap_column = (int)MODULE_FRONT_PAGE_NEW_PRODUCTS_COMPARE_COLUMNS;
// initialisation des boutons
            $size_button = $CLICSHOPPING_ProductsCommon->getSizeButton('md');

// Template define
            $filename = $CLICSHOPPING_Template->getTemplateModulesFilename($this->group .'/template_html/' . MODULE_FRONT_PAGE_NEW_PRODUCTS_COMPARE_TEMPLATE);

            $new_prods_content = '<!-- New Products start -->' . "\n";

            if (MODULE_FRONT_PAGE_NEW_PRODUCTS_COMPARE_FRONT_TITLE == 'True') {
              $new_prods_content .= '<div class="ModuleFrontPageProductsNewHeading"><h2>' . CLICSHOPPING::getDef('module_front_page_new_products_compare_heading_title') . '</h2></div>';
            }
...
//Stock (good, alert, out of stock).
              $products_stock = $CLICSHOPPING_ProductsFunctionTemplate->getStock(MODULE_FRONT_PAGE_NEW_PRODUCTS_COMPARE_DISPLAY_STOCK, $products_id);
//Flash discount
...
// Display an input allowing for the customer to insert a quantity
              $input_quantity = $CLICSHOPPING_ProductsFunctionTemplate->getDisplayInputQuantity(MODULE_FRONT_PAGE_NEW_PRODUCTS_COMPARE_DELETE_BUY_BUTTON, $products_id);
...
// **************************
              ...
              if (MODULE_FRONT_PAGE_NEW_PRODUCTS_COMPARE_DELETE_BUY_BUTTON == 'False') {
...
// See the button more view details
               $button_small_view_details = $CLICSHOPPING_ProductsFunctionTemplate->getButtonViewDetails(MODULE_FRONT_PAGE_NEW_PRODUCTS_COMPARE_DELETE_BUY_BUTTON, $products_id);
// Display the image
              $products_image = $CLICSHOPPING_ProductsFunctionTemplate->getImage(MODULE_FRONT_PAGE_NEW_PRODUCTS_COMPARE_IMAGE_MEDIUM, $products_id);
// Ticker Image
              $products_image .= $CLICSHOPPING_ProductsFunctionTemplate->getTicker(MODULE_FRONT_PAGE_NEW_PRODUCTS_COMPARE_TICKER, $products_id, 'ModulesFrontPageTickerBootstrapTickerSpecial', 'ModulesFrontPageTickerBootstrapTickerFavorite', 'ModulesFrontPageTickerBootstrapTickerFeatured', 'ModulesFrontPageTickerBootstrapTickerNew');

              $ticker = $CLICSHOPPING_ProductsFunctionTemplate->getTickerPourcentage(MODULE_FRONT_PAGE_NEW_PRODUCTS_COMPARE_POURCENTAGE_TICKER, $products_id, 'ModulesFrontPageTickerBootstrapTickerPourcentage');
...
// products_compare
            $new_prods_content .= '<div class="col-md-12 stickProductsCompare" id="compare">';
            $new_prods_content .= '<div class="separator"></div>';
            $new_prods_content .= '<div class="text-md-center">';
            $new_prods_content .= '<button class="btn">';
            $new_prods_content .= HTML::link(CLICSHOPPING::link(null, 'Compare&ProductsCompare'), CLICSHOPPING::getDef('text_products_compare_selected')) . '</button>';
            $new_prods_content .= '</div>';
            $new_prods_content .= '</div>';
            $new_prods_content .= '</form>';
    ...
    public function check() {
      return defined('MODULE_FRONT_PAGE_NEW_PRODUCTS_COMPARE_STATUS');
    }
    ...
    public function install() {
      ...
      $CLICSHOPPING_Db->save('configuration', [
          ...
          'configuration_key' => 'MODULE_FRONT_PAGE_NEW_PRODUCTS_COMPARE_STATUS',
      ...
      $CLICSHOPPING_Db->save('configuration', [
          ...
          'configuration_key' => 'MODULE_FRONT_PAGE_NEW_PRODUCTS_COMPARE_TEMPLATE',
      ...
      $CLICSHOPPING_Db->save('configuration', [
          ...
          'configuration_key' => 'MODULE_FRONT_PAGE_NEW_PRODUCTS_COMPARE_FRONT_TITLE',
          'configuration_value' => 'True',
      ...
      $CLICSHOPPING_Db->save('configuration', [
          ...
          'configuration_key' => 'MODULE_FRONT_PAGE_NEW_PRODUCTS_COMPARE_MAX_DISPLAY',
      ...
      $CLICSHOPPING_Db->save('configuration', [
          ...
          'configuration_key' => 'MODULE_FRONT_PAGE_NEW_PRODUCTS_COMPARE_COLUMNS',
          'configuration_value' => '6',
      ...
      $CLICSHOPPING_Db->save('configuration', [
          ...
          'configuration_key' => 'MODULE_FRONT_PAGE_NEW_PRODUCTS_COMPARE_SHORT_DESCRIPTION',
      ...
      $CLICSHOPPING_Db->save('configuration', [
          ...
          'configuration_key' => 'MODULE_FRONT_PAGE_NEW_PRODUCTS_COMPARE_SHORT_DESCRIPTION_DELETE_WORLDS',
          'configuration_value' => '0',
      ...
      $CLICSHOPPING_Db->save('configuration', [
          ...
          'configuration_key' => 'MODULE_FRONT_PAGE_NEW_PRODUCTS_COMPARE_TICKER',
      ...
      $CLICSHOPPING_Db->save('configuration', [
          ...
          'configuration_key' => 'MODULE_FRONT_PAGE_NEW_PRODUCTS_COMPARE_POURCENTAGE_TICKER',
          'configuration_value' => 'False',
      ...
      $CLICSHOPPING_Db->save('configuration', [
          ...
          'configuration_key' => 'MODULE_FRONT_PAGE_NEW_PRODUCTS_COMPARE_DISPLAY_STOCK',
      ...
      $CLICSHOPPING_Db->save('configuration', [
          ...
          'configuration_key' => 'MODULE_FRONT_PAGE_NEW_PRODUCTS_COMPARE_IMAGE_MEDIUM',
      ...
      $CLICSHOPPING_Db->save('configuration', [
          ...
          'configuration_key' => 'MODULE_FRONT_PAGE_NEW_PRODUCTS_COMPARE_DELETE_BUY_BUTTON',
          'configuration_value' => 'False',
      ...
      $CLICSHOPPING_Db->save('configuration', [
          ...
          'configuration_key' => 'MODULE_FRONT_PAGE_NEW_PRODUCTS_COMPARE_SORT_ORDER',
    ...
    public function keys() {
      return array ('MODULE_FRONT_PAGE_NEW_PRODUCTS_COMPARE_STATUS',
                    'MODULE_FRONT_PAGE_NEW_PRODUCTS_COMPARE_TEMPLATE',
                    'MODULE_FRONT_PAGE_NEW_PRODUCTS_COMPARE_FRONT_TITLE',
                    'MODULE_FRONT_PAGE_NEW_PRODUCTS_COMPARE_MAX_DISPLAY',
                    'MODULE_FRONT_PAGE_NEW_PRODUCTS_COMPARE_COLUMNS',
                    'MODULE_FRONT_PAGE_NEW_PRODUCTS_COMPARE_SHORT_DESCRIPTION',
                    'MODULE_FRONT_PAGE_NEW_PRODUCTS_COMPARE_SHORT_DESCRIPTION_DELETE_WORLDS',
                    'MODULE_FRONT_PAGE_NEW_PRODUCTS_COMPARE_TICKER',
                    'MODULE_FRONT_PAGE_NEW_PRODUCTS_COMPARE_POURCENTAGE_TICKER',
                    'MODULE_FRONT_PAGE_NEW_PRODUCTS_COMPARE_DISPLAY_STOCK',
                    'MODULE_FRONT_PAGE_NEW_PRODUCTS_COMPARE_IMAGE_MEDIUM',
                    'MODULE_FRONT_PAGE_NEW_PRODUCTS_COMPARE_DELETE_BUY_BUTTON',
                    'MODULE_FRONT_PAGE_NEW_PRODUCTS_COMPARE_SORT_ORDER'
                   );
    }
  }
